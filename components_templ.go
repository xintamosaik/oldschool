...
func Title() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section id=\"title\"><h1><span>Ulf Dellbrügge</span> <span class=\"dash\"></span> <span>SOFTWARE ENGINEER (FULL-STACK / TYPESCRIPT)</span></h1></section>")
		if templ_7745c5c3_Err != nil {
...
func Subtitle() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<section id=\"subtitle\"><p><strong>Full-stack software engineer building reliable TypeScript, frontend, and backend systems</strong></p></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func Contact1() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<section id=\"contact\"><p><span>Relocating to London (Skilled Worker visa route)</span> <span class=\"dash\"></span> <span>Open to sponsorship</span></p></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func CommercialImpact() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<section id=\"commercial_impact\"><h2>Commercial Impact Highlights</h2><ul><li><strong>Replaced a 5,000+ LOC legacy AdController</strong> with a 60-line config-driven system → removed third-party dependency and enabled version-controlled deployments</li><li>Reduced delivery feedback loops from 3–5 minutes to under 1 second, accelerating iteration and release confidence</li><li>Cut bug rates ~20% in key workflows, improving system stability and stakeholder trust</li></ul></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func Summary() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<section id=\"summary\"><h2>Summary</h2><p>Software Engineer experienced in TypeScript, JavaScript, React, Vue, Node.js, and containerised services. Strong track record of modernising legacy systems, improving delivery speed, and shipping maintainable production software.</p><p>Comfortable working across frontend, backend, tooling, and infrastructure, with experience in Dockerised microservice environments and complex legacy codebases.</p><p>Particularly effective in ambiguous environments where systems need to be understood, simplified, stabilised, and moved toward better engineering practices.</p></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func Skills() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<section><h2>Skills</h2><ul><li><strong>Core Stack:</strong> TypeScript, JavaScript (ES6+), React, Vue, Node.js (Fastify)</li><li><strong>Infrastructure & DevOps:</strong> Docker, Kubernetes, GitHub Actions, GitLab CI, AWS, GCP</li><li><strong>Data & Storage:</strong> MongoDB, SQL (MySQL/PostgreSQL), ORM</li><li><strong>Tooling & Quality:</strong> ESLint, JSDoc, TDD/BDD, CI/CD, DevOps practices</li></ul></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func TodoNew() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "<div>new</div><button hx-get=\"/\" hx-target=\"body\">back</button>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
