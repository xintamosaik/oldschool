...
func Contact1() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section id=\"contact\"><p><span>Relocating to London (Skilled Worker visa route)</span> <span class=\"dash\"></span> <span>Open to sponsorship</span></p></section>")
		if templ_7745c5c3_Err != nil {
...
func CommercialImpact() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<section id=\"commercial_impact\"><h2>Commercial Impact Highlights</h2><ul><li><strong>Replaced a 5,000+ LOC legacy AdController</strong> with a 60-line config-driven system → removed third-party dependency and enabled version-controlled deployments</li><li>Reduced delivery feedback loops from 3–5 minutes to under 1 second, accelerating iteration and release confidence</li><li>Cut bug rates ~20% in key workflows, improving system stability and stakeholder trust</li></ul></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func Summary() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<section id=\"summary\"><h2>Summary</h2><p>Software Engineer experienced in TypeScript, JavaScript, React, Vue, Node.js, and containerised services. Strong track record of modernising legacy systems, improving delivery speed, and shipping maintainable production software.</p><p>Comfortable working across frontend, backend, tooling, and infrastructure, with experience in Dockerised microservice environments and complex legacy codebases.</p><p>Particularly effective in ambiguous environments where systems need to be understood, simplified, stabilised, and moved toward better engineering practices.</p></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func TodoNew() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "<div>new</div><button hx-get=\"/\" hx-target=\"body\">back</button>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
