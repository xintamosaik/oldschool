...
func Skills() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<section><h2>Skills</h2><ul><li><strong>Core Stack:</strong> TypeScript, JavaScript (ES6+), React, Vue, Node.js (Fastify)</li><li><strong>Infrastructure & DevOps:</strong> Docker, Kubernetes, GitHub Actions, GitLab CI, AWS, GCP</li><li><strong>Data & Storage:</strong> MongoDB, SQL (MySQL/PostgreSQL), ORM</li><li><strong>Tooling & Quality:</strong> ESLint, JSDoc, TDD/BDD, CI/CD, DevOps practices</li></ul></section>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
...
func TodoNew() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<div>new</div><button hx-get=\"/\" hx-target=\"body\">back</button>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
